...
import photo6 from "./5.jpg";
import photo7 from "./5.jpg";
import photo8 from "./5.jpg";
import photo9 from "./5.jpg";
import photo10 from "./5.jpg";
import photo11 from "./5.jpg";
import photo12 from "./5.jpg";
...
<Row>
    <Col lg={4} className="overflow-hidden p-0"><img className="grid-item" src={photo1} alt="" /></Col>
    <Col lg={4} className="overflow-hidden p-0"><img className="grid-item" src={photo1} alt="" /></Col>
    <Col lg={4} className="overflow-hidden p-0"><img className="grid-item" src={photo1} alt="" /></Col>
  </Row>
  <Row>

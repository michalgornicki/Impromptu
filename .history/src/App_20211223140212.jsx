...
>
  ...
  <Col>
  <div className="display-7 text-center mb-2">
    Pomoc i kontakt
  </div>
  <Nav.Item>
    <Nav.Link eventKey="link-1">At vero eos et accusamus</Nav.Link>
  </Nav.Item>
  <Nav.Item>
    <Nav.Link eventKey="link-2">At vero eos et accusamus</Nav.Link>
  </Nav.Item>
  <Nav.Item>
    <Nav.Link eventKey="link-2">At vero eos et accusamus</Nav.Link>
  </Nav.Item>
  ...
  <Nav.Item>
    <Nav.Link className="text-light" eventKey="link-1">At vero eos et accusamus</Nav.Link>
  </Nav.Item>
  <Nav.Item>
    <Nav.Link eventKey="link-2">At vero eos et accusamus</Nav.Link>
  </Nav.Item>

...
<div className="mb-5 flex flex-row">
  <div className="overflow-hidden col-lg-4 m-0"><img className="grid-item" src={photo1} alt="" /></div>
  <div className="overflow-hidden col-lg-4"><img className="grid-item" src={photo1} alt="" /></div>
  <div className="overflow-hidden col-lg-4"><img className="grid-item" src={photo1} alt="" /></div>
</div>
<div className="mb-5">
...
<div className="mb-5">
<div className="overflow-hidden"><img className="grid-item" src={photo3} alt="" /></div>
<div className="overflow-hidden"> <img className="grid-item" src={photo3} alt="" /></div>
<div className="overflow-hidden"> <img className="grid-item" src={photo3} alt="" /></div>
</div>
</Container>

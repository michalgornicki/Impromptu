...
function App() {
  return (
    <p>
      ...
      <Row>
      <Col lg={4} className="overflow-hidden p-0">
            <img className="square-photo border-5" src={photo15} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="square-photo n border-5" src={photo16} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="square-photo border-5" src={photo17} alt="" />
          </Col>

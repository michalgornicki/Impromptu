...
<div className="mb-5">
  <div className="overflow-hidden"><img className="grid-item" src={photo1} alt="" /></div>
  <div className="overflow-hidden"><img className="grid-item" src={photo1} alt="" />
  <div className="overflow-hidden"></div><img className="grid-item" src={photo1} alt="" />
</div>
<div className="mb-5">
<div className="overflow-hidden"></div><img className="grid-item" src={photo2} alt="" />
<div className="overflow-hidden"><img className="grid-item" src={photo2} alt="" />
<div className="overflow-hidden"><img className="grid-item" src={photo2} alt="" />
</div>
<div className="mb-5">
<div className="overflow-hidden"></div><img className="grid-item" src={photo3} alt="" />
<div className="overflow-hidden"> <img className="grid-item" src={photo3} alt="" />
<div className="overflow-hidden"> <img className="grid-item" src={photo3} alt="" />
</div>
</Container>

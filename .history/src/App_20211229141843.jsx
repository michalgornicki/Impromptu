...
import photo15 from "./14.jpg";
import photo16 from "./14.jpg";
import photo17 from "./14.jpg";
...
function App() {
  return (
    <p>
      ...
      <Row>
      <Col lg={4} className="overflow-hidden p-0">
            <img className="square-photo" src={photo15} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="square-photo" src={photo16} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="square-photo" src={photo17} alt="" />
          </Col>

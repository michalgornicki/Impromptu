      ...
      <Container className="mt-5">
        <Row>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo6} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo7} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo8} alt="" />
          </Col>
        </Row>
        <Row>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo9} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo10} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo11} alt="" />
          </Col>
        </Row>
        <Row>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo12} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo13} alt="" />
          </Col>
          <Col lg={4} className="overflow-hidden p-0">
            <img className="grid-item" src={photo14} alt="" />
          </Col>
        </Row>
      </Container>

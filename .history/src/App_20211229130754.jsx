...
import Col from "react-bootstrap/import "bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js";
";
...
function App() {
  return (
    <p>
      ...
      >
        <Container>
          <Navbar.Brand href="#home" className="text-bold px-2">IMPROMPTU</Navbar.Brand>
